      ...
      <div className="overflow-hidden w-full px-4 sm:px-6 md:px-8" ref={emblaRef}>
        <div className="flex gap-3 md:gap-8 max-w-6xl mx-auto">
          {displayedCategories.map((cat, i) => (
            ...
            >
              <div className="w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 rounded-full overflow-hidden mb-4 md:mb-6 border-4 border-transparent group-hover:border-wine transition-all duration-300 bg-gray-100 flex items-center justify-center">
